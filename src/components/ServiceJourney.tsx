 ...
 */
const TILES: Tile[] = [
  { image: '/collage-1.webp', caption: 'Meetings', x: 137.7, y: 813.7, rotate: 153.61 },
  { image: '/collage-2.webp', caption: 'Dining', x: -36.83, y: 543.39, rotate: 179.32 },
  { image: '/collage-3.webp', caption: 'Travel', x: -53.22, y: 183.36, rotate: -26.39 },
  { image: '/collage-4.webp', caption: 'Experiences', x: 759.63, y: 936.63, rotate: -26.39 },
  { image: '/collage-5.webp', caption: 'Events', x: 285.6, y: 27.45, rotate: -129.25 },
  { image: '/finale/01.webp', x: 1077.17, y: 50.11, rotate: -52.1 },
  { image: '/finale/02.webp', x: 1372.31, y: 201.1, rotate: -26.39 },
  { image: '/finale/03.webp', x: 1253.46, y: 778.5, rotate: -26 },
];
...
const FINALE_IMAGES = Array.from(
  { length: 12 },
  (_, i) => `/finale/${String(i + 1).padStart(2, '0')}.webp`
);
